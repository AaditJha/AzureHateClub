...
def create_map_request(shard: list[int], centroids: list[list[float]], num_reducers: int, write_mode : str) -> mapper_pb2.MapRequest:
    ...
    map_request.write_mode = write_mode
    return map_request
